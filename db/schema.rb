...
ActiveRecord::Schema.define(version: 2020_01_18_015228) do
  ...
  create_table "categoria_productos", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.bigint "producto_id", null: false
    t.bigint "category_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["category_id"], name: "index_categoria_productos_on_category_id"
  ...
  add_foreign_key "categoria_productos", "categories"
